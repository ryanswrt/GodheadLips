   ...
   {"choice", "Oh. Hello, sir! I didn't expect to find anyone out here."},
     ...
     --Now here we branch with 2 choices
       {"choice", "Are you sure? I think you lost me.",
         ...
         {"choice","Then, I'm <playername> headed for... for.. Hyalang was it?"}
       ...
       {"say", "Fengzhi", "Pleased to meet you, <playername>, traveling to Hyalang. What is your purpose?"},
      ...
      {"choice","You'd like my uncle, then. [smile]",
        ...
        {"choice","Why do you celebrate death?",
