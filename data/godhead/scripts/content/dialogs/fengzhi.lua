...
-- Link to Godhean's code style guidelines: http://dungeonhack.sourceforge.net/Code_Style_Guidelines
...
Dialogspec{name = "fengzhi", unique = true, {"branch", cond_dead = true, {"loot"}},
    ...
    {"say", "Fengzhi", "That's quite an assumption you make there, stranger."}, {"flag", "FengMet"},
       ...
       {"say", "Fengzhi", "You start with presumptions, and fllow up with imperatives. The illusion of control must be very dear to you."},
           {"choice", "Perhaps so. I am <avatar_name>. What may I call you then?"},
           {"say", "Fengzhi", "What would you call me? I don't think of myself as my name, but I appreciate taht your existence must be quite simple, <avatar_name>"},
               {"choice", "It is. I'm simply lost! Perhpas I'll stay lost awhile... Stranger. You're a strange sort, but in a likable way. Are you lost too?",
