...
#ifndef __PHYSICS_CONVEXCAST_HPP__
#define __PHYSICS_CONVEXCAST_HPP__

class LIPhyConvexcastWorld : public btCollisionWorld::ClosestConvexResultCallback
{
public:
	LIPhyConvexcastWorld (LIPhyObject** ignore_array, int ignore_count) :
